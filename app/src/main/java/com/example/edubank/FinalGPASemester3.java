...
public class FinalGPASemester3 extends AppCompatActivity {
    //Initialize variable
    ImageView backbtn;
    ...
    private double credits3;
    private double total_gpa3;
    private double cumutative_gradePoints3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GPA Calculation
        //Total Grade Points in Semester 3
        total_gpa3 = addGPASemThree(getGradePoint(grade1), getGradePoint(grade2), getGradePoint(grade3), getGradePoint(grade4), getGradePoint(grade5));
        //GPA of Semester 3
        gpa3 = calculateGPASemThree(total_gpa3, 5.0);

        //GPA View
        gpaView.setText(Double.toString(gpa3));

        //CGPA Calculation
        //Cumulative Credits
        credits3 = addCreditsSemThree(getCredit(credit1), getCredit(credit2), getCredit(credit3), getCredit(credit4), getCredit(credit5));
        //Cumulative Grade Points
        cumutative_gradePoints3 = multiplyGradePointsSemThree(getGradePoint(grade1), getCredit(credit1), getGradePoint(grade2), getCredit(credit2), getGradePoint(grade3), getCredit(credit3), getGradePoint(grade4), getCredit(credit4), getGradePoint(grade5), getCredit(credit5));
        //CGPA of Semester 3
        cgpa3 = calculateCGPASemThree(credits3, cumutative_gradePoints3);

        //CGPA View
        cgpaView.setText(Double.toString(cgpa3));

        //Direct to Previous Interface
        backbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent studentSemesterRsultsIntent = new Intent(FinalGPASemester3.this, StudentSemester3Results.class);
        ...
        backtocalculategpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backCalculateGPAIntent = new Intent(FinalGPASemester3.this, CalculateGPA.class);
    ...
    //Semester 3 Total Grade Points Calculation Method
    private double addGPASemThree(double grade1, double grade2, double grade3, double grade4, double grade5) {
        return grade1 + grade2 + grade3 + grade4 + grade5;
    }

    //Semester 3 GPA Calculation Method
    private double calculateGPASemThree(double total_gpa, double v) {
        return total_gpa / v;
    }

    //Cumulative Credits Calculation Method
    private double addCreditsSemThree(double credit1, double credit2, double credit3, double credit4, double credit5) {
        return credit1 + credit2 + credit3 + credit4 + credit5;
    }

    //Cumulative Grade Points Calculation Method
    private double multiplyGradePointsSemThree(double gradePoint1, double credit1, double gradePoint2, double credit2, double gradePoint3, double credit3, double gradePoint4, double credit4, double gradePoint5, double credit5) {
        return ((gradePoint1 * credit1) + (gradePoint2 * credit2) + (gradePoint3 * credit3) + (gradePoint4 * credit4) + (gradePoint5 * credit5));
    }

    //Semester 3 CGPA Calculation Method
    private double calculateCGPASemThree(double credits, double cumutative_gradePoints) {
