...
public class StudentSemester8Results extends AppCompatActivity {
    //Initialize variable
    ImageView backbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent semesterModNoIntent = new Intent(StudentSemester8Results.this, CalculateGPA.class);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Semester8").child("Results");
            ...
            public void onClick(View v) {
                try {
                    if (TextUtils.isEmpty(module1.getText().toString()) || TextUtils.isEmpty(module2.getText().toString()) || TextUtils.isEmpty(module3.getText().toString()) || TextUtils.isEmpty(module4.getText().toString()) || TextUtils.isEmpty(module5.getText().toString()))
                        ...
                        Toast.makeText(StudentSemester8Results.this, "Module 1 Details Added Successfully", Toast.LENGTH_LONG).show();
                        ...
                        maxid +=1;
                        reference.child("Module").child(String.valueOf(maxid)).setValue(results);
                        Toast.makeText(StudentSemester8Results.this, "Module 2 Details Added Successfully", Toast.LENGTH_LONG).show();
                        ...
                        maxid +=1;
                        reference.child("Module").child(String.valueOf(maxid)).setValue(results);
                        Toast.makeText(StudentSemester8Results.this, "Module 3 Details Added Successfully", Toast.LENGTH_LONG).show();
                        ...
                        maxid +=1;
                        reference.child("Module").child(String.valueOf(maxid)).setValue(results);
                        Toast.makeText(StudentSemester8Results.this, "Module 4 Details Added Successfully", Toast.LENGTH_LONG).show();
                        ...
                        maxid +=1;
                        reference.child("Module").child(String.valueOf(maxid)).setValue(results);
                        Toast.makeText(StudentSemester8Results.this, "Module 5 Details Added Successfully", Toast.LENGTH_LONG).show();
                        clear();
                    }
                } catch (NumberFormatException e) {
                    Toast.makeText(getApplicationContext(), "Invalid Number Type", Toast.LENGTH_LONG).show();
                }
                Intent finalGPAIntent = new Intent(StudentSemester8Results.this, FinalGPASemester8.class);
