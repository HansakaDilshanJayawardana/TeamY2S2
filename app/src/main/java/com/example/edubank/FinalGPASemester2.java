...
public class FinalGPASemester2 extends AppCompatActivity {
    ...
    private double total_gpa2;
    private double cumutative_gradePoints2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GPA Calculation
        //Total Grade Points in Semester 2
        total_gpa2 = addGPASemTwo(getGradePoint(grade1), getGradePoint(grade2), getGradePoint(grade3), getGradePoint(grade4), getGradePoint(grade5));
        //GPA of Semester 2
        gpa2 = calculateGPASemTwo(total_gpa2, 5.0);
        ...
        //CGPA Calculation
        //Cumulative Credits
        credits2 = addCreditsSemTwo(getCredit(credit1), getCredit(credit2), getCredit(credit3), getCredit(credit4), getCredit(credit5));
        //Cumulative Grade Points
        cumutative_gradePoints2 = multiplyGradePointsSemTwo(getGradePoint(grade1), getCredit(credit1), getGradePoint(grade2), getCredit(credit2), getGradePoint(grade3), getCredit(credit3), getGradePoint(grade4), getCredit(credit4), getGradePoint(grade5), getCredit(credit5));
        //CGPA of Semester 2
        cgpa2 = calculateCGPASemTwo(credits2, cumutative_gradePoints2);
    ...
    //Semester 2 Total Grade Points Calculation Method
    private double addGPASemTwo(double grade1, double grade2, double grade3, double grade4, double grade5) {
        return grade1 + grade2 + grade3 + grade4 + grade5;
    }

    //Semester 2 GPA Calculation Method
    private double calculateGPASemTwo(double total_gpa, double v) {
        return total_gpa / v;
    }

    //Cumulative Credits Calculation Method
    private double addCreditsSemTwo(double credit1, double credit2, double credit3, double credit4, double credit5) {
        return credit1 + credit2 + credit3 + credit4 + credit5;
    }

    //Cumulative Grade Points Calculation Method
    private double multiplyGradePointsSemTwo(double gradePoint1, double credit1, double gradePoint2, double credit2, double gradePoint3, double credit3, double gradePoint4, double credit4, double gradePoint5, double credit5) {
        return ((gradePoint1 * credit1) + (gradePoint2 * credit2) + (gradePoint3 * credit3) + (gradePoint4 * credit4) + (gradePoint5 * credit5));
    }

    //Semester 2 CGPA Calculation Method
    private double calculateCGPASemTwo(double credits, double cumutative_gradePoints) {
