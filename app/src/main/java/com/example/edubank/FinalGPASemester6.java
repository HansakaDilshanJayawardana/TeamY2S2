...
public class FinalGPASemester6 extends AppCompatActivity {
    ...
    private double total_gpa6;
    private double cumutative_gradePoints6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GPA Calculation
        //Total Grade Points in Semester 6
        total_gpa6 = addGPASemSix(getGradePoint(grade1), getGradePoint(grade2), getGradePoint(grade3), getGradePoint(grade4), getGradePoint(grade5));
        //GPA of Semester 6
        gpa6 = calculateGPASemSix(total_gpa6, 5.0);
        ...
        //CGPA Calculation
        //Cumulative Credits
        credits6 = addCreditsSemSix(getCredit(credit1), getCredit(credit2), getCredit(credit3), getCredit(credit4), getCredit(credit5));
        //Cumulative Grade Points
        cumutative_gradePoints6 = multiplyGradePointsSemSix(getGradePoint(grade1), getCredit(credit1), getGradePoint(grade2), getCredit(credit2), getGradePoint(grade3), getCredit(credit3), getGradePoint(grade4), getCredit(credit4), getGradePoint(grade5), getCredit(credit5));
        //CGPA of Semester 6
        cgpa6 = calculateCGPASemSix(credits6, cumutative_gradePoints6);
    ...
    //Semester 6 Total Grade Points Calculation Method
    private double addGPASemSix(double grade1, double grade2, double grade3, double grade4, double grade5) {
        return grade1 + grade2 + grade3 + grade4 + grade5;
    }

    //Semester 6 GPA Calculation Method
    private double calculateGPASemSix(double total_gpa, double v) {
        return total_gpa / v;
    }

    //Cumulative Credits Calculation Method
    private double addCreditsSemSix(double credit1, double credit2, double credit3, double credit4, double credit5) {
        return credit1 + credit2 + credit3 + credit4 + credit5;
    }

    //Cumulative Grade Points Calculation Method
    private double multiplyGradePointsSemSix(double gradePoint1, double credit1, double gradePoint2, double credit2, double gradePoint3, double credit3, double gradePoint4, double credit4, double gradePoint5, double credit5) {
        return ((gradePoint1 * credit1) + (gradePoint2 * credit2) + (gradePoint3 * credit3) + (gradePoint4 * credit4) + (gradePoint5 * credit5));
    }

    //Semester 6 CGPA Calculation Method
    private double calculateCGPASemSix(double credits, double cumutative_gradePoints) {
