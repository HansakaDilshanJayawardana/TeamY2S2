    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent studentSemesterRsultsIntent = new Intent(FinalGPASemester8.this, StudentSemester8Results.class);
        ...
        backtocalculategpabtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backCalculateGPAIntent = new Intent(FinalGPASemester8.this, CalculateGPA.class);
