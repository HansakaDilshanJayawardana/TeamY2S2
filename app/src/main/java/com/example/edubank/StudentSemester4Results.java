    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent semesterModNoIntent = new Intent(StudentSemester4Results.this, CalculateGPA.class);
        ...
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Semester4").child("Results");
